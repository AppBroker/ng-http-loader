...
var SpinnerComponent = (function () {
    function SpinnerComponent(pendingInterceptorService, spinnerVisibilityService) {
        ...
        this.subscriptions = rxjs_1.merge(this.pendingInterceptorService.pendingRequestsStatus.pipe(operators_1.debounce(this.handleDebounce.bind(this))), this.spinnerVisibilityService.visibilityObservable)
    ...
    SpinnerComponent.prototype.handleDebounce = function (hasPendingRequests) {
        if (hasPendingRequests) {
            return rxjs_1.timer(this.debounceDelay);
        }
        return rxjs_1.timer(0);
    };
